        ...
        <div>
          ...
          <div className="flex lg:flex-row lg:justify-between lg:gap-16 flex-col-reverse gap-9">
            ...
            <div className="basis-1/2">
              <div className="flex items-center lg:flex-row h-fit border-dashed border-[#292F4A] border-b-2 pb-8 justify-between">
              ...
              <div className="flex flex-col gap-3 pt-8">
                <div className="flex justify-between items-center">
                  ...
                  <h2 className="text-primary font-normal font-freize lg:text-lg lg:leading-[34px]">NGN 34,453</h2>
                </div>
                <div className="flex justify-between items-center">
                  <h2 className="text-primary font-normal font-freize lg:text-lg lg:leading-[34px]">Delivery</h2>
                  <h2 className="text-primary font-normal font-freize lg:text-lg lg:leading-[34px]">Free</h2>
                </div>
                <div className="flex justify-between items-center">
                  <h2 className="text-primary font-bold font-freize lg:text-[25px] lg:leading-[34px]">Total</h2>
                  <h2 className="text-primary  font-bold font-freize lg:text-[25px] lg:leading-[34px]">NGN 34,599</h2>
                </div>
              </div>
            </div>
          </div>
