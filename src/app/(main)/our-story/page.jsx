          ...
          <div className="basis-1/2">
            <AnimateOnScroll animation="fade-up">
              <p className="font-freize font-normal lg:text-xl text-[15px] lg:leading-[35px]">
                From Cleopatra's legendary milk baths to the century old beauty
                rituals of Local Nigerian tribes and vibrant red women of
                Namibia. The thing is its always been here in Africa. Throughout
                the ages, from the reigns of Queen Amina, Cleopatra, Nefertiti,
                to the majestic kingdoms of Ashanti, Benin, Mali, and ancient
                Egypt,
              </p>
            </AnimateOnScroll>
          </div>
          ...
          <div className="basis-1/2">
            <AnimateOnScroll animation="fade-up">
              <p className="font-freize lg:text-xl font-normal text-[15px] lg:leading-[35px]">
                ...
                unparalleled beauty rituals and holistic well-being. Despite
                the shift, driven by media proliferation and globalization,
                African Rhapsody stands as a beacon, reminding the world that
          ...
          <div className="basis-1/2 flex flex-col gap-3">
            <AnimateOnScroll animation="fade-up">
              <p className="font-freize font-normal lg:text-lg text-[15px] leading-[35px] lg:leading-[30px]">
                At African Rhapsody we research and transform Africa's botanical
                wisdom with cutting-edge cosmetic science into innovative
                skincare solutions. More than a beauty brand; it's a journey to
                rediscover the wonders of the earth, once lost but now found,
                hidden yet Uncovered. Welcome to the era of African-inspired
                beauty - every product is a celebration that transcends time
                and embraces the genuine essence of caring, nourishing, and
                healing from within
              </p>
            </AnimateOnScroll>
